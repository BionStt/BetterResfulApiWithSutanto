...
namespace WebApi.SalesMarketing.ServiceApplication.DataSPK.Commands.CreateDataSPKKredit
{
    public class CreateDataSPKKreditCommandHandler : IRequestHandler<CreateDataSPKKreditCommand, Guid>
    {
        ...
        public async Task<Guid> Handle(CreateDataSPKKreditCommand request, CancellationToken cancellationToken)
        {
            ...
            var dtSPK2 = await _context.DataSPK.SingleOrDefaultAsync(x => x.NoUrutId == request.DataSPKId);
            ...
            if (dtSPK2 != null)
            {
                dtSPK2.AddDataSPKKredit(dtSPKKredit);
            }
